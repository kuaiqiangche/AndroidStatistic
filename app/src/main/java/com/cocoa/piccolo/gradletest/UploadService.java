...
import com.cocoa.piccolo.gradletest.statistical.UploadCommon;
import com.cocoa.piccolo.gradletest.util.DeviceInfoUtils;
import com.cocoa.piccolo.gradletest.util.Logger;
...
public class UploadService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        if (intent != null) {
            ...
            if (o != null) {
                ArrayList<StatisticalEvent> list = (ArrayList<StatisticalEvent>) o;
